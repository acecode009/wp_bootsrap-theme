...
<section class="showcase">
        <div class="container">
            <h1><?php echo get_theme_mod('showcase_heading','Custom Bootrap Wordpress Theme'); ?></h1>
            <p><?php echo get_theme_mod('showcase_text', 'landing page with bootsrap framework, responsive and dynamic') ?></p>
